...
using Tumblr10Nav.Controls;
using Tumblr10Nav.Views;
    ...
    public sealed partial class AppShell : Page
    {
        ...
        private List<NavMenuItem> navlist = new List<NavMenuItem>(
            new[]
            {
                ...
                {
                    Symbol = Symbol.Flag,
                    Label = "Show by Country",
                    DestinationPage = typeof(Views.PageByCountry)
                },
                  new NavMenuItem()
                {
                    Symbol = Symbol.World,
                    Label = "Show on Map",
                    DestinationPage = typeof(Views.PageOnMap)
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.Link,
                    ...
                    Arguments = "http://ikivanc.tumblr.com",
                }
            });
